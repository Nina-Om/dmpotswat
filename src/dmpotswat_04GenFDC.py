...
if not os.path.isdir(fdCalibrated):
    print("""The {} folder does not exist, please double check! This 
            usually means you haven't run your applyBestParmSet 
            for calibration and validation yet.""".format(fdCalibrated))
...
<<<<<<< HEAD:src/dmpotswat_04GenFDC.py
=======
print("                   Last Updated: 2021-05-09                      ")
>>>>>>> 066ead8c5aea90e3565586d3fe4e24209086cc8d:dmpotswat_GenFDC_20210509.py
print("=================================================================")
